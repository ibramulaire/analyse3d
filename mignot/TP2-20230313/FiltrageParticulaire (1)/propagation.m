function Particules = propagation(Particules,Config,Estimation,frame)
	...
	alea = Config.sigma_propagation*randn(Config.nombre_de_particule,2);%tableau de variable alea normalement distribuer
	%deplacements selon aleatoire 
  ...
  %Assure que c'est toujour dans la fenetre
